...
public class AssetEditRequestMapper {
    ...
    public UiAssetCreateRequest buildCreateRequest(@NonNull UiAssetEditRequest editRequest, @NonNull String assetId) {
        ...
        return UiAssetCreateRequest.builder()
            ...
            .drkAssetType(editRequest.getDrkAssetType())
            .drkUpdateCheckFrequency(editRequest.getDrkUpdateCheckFrequency())
            .drkTheatreName(editRequest.getDrkTheatreName())
            .drkTheatreStreetaddress(editRequest.getDrkTheatreStreetaddress())
            .drkTheatrePostalCode(editRequest.getDrkTheatrePostalCode())
            .drkTheatrePostalCode(editRequest.getDrkTheatrePostalCode())
            .drkTheatreLocality(editRequest.getDrkTheatreLocality())
            .drkTheatreCountry(editRequest.getDrkTheatreCountry())
            .drkMuseumName(editRequest.getDrkMuseumName())
            .drkMusicSchoolName(editRequest.getDrkMusicSchoolName())
